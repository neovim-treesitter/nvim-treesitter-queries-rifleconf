# nvim-treesitter-queries-rifleconf

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-rifleconf/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-rifleconf/actions/workflows/validate.yml)

Neovim tree-sitter queries for **rifleconf**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-rifleconf",
...
- [ ] Changes are scoped to `rifleconf` — do not include files for other languages
